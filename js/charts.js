...
var visitorChart = document.getElementById("myBarChart");
 var myLineChart = new Chart(visitorChart, {
  type: 'bar',
  data: {
    ...
    datasets: [{
      ...
      borderColor: "rgba(2,117,216,1)",
      data: [4215, 5312, 6251, 7841, 9821, 15984],
    }],
  },
  options: {
    scales: {
...
var myPieChart = new Chart(citiesChart, {
  type: 'pie',
  data: {
    labels: ["Riyadh", "Makkah", "Jeddah", "Shargia"],
    datasets: [{
      data: [12.21, 15.58, 1.25, 18.32],
...
//-------------------------------------------------------------
// Liner Chart for Rat
 var ctx = document.getElementById("myLinearChart");
var myLineChart = new Chart(ctx, {
    type: 'line',
    data: {
      labels: ["January", "February", "March", "April", "May", "June"],
